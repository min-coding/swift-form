    ...
    <form>
      ...
      <div className="input_container">
        ...
        <input
          ...
          required
          onChange={(e) =>
            dispatch(updateUserForm({ lastname: e.target.value }))
          }
        ></input>
      </div>
      ...
      <div className="input_container">
        ...
        <input
          ...
          onChange={(e) =>
            dispatch(
              updateUserForm({ expected_salary: Number(e.target.value) }),
            )
          }
        ></input>
      </div>
      <button type="submit" onClick={handleSubmit} disabled={!valid}>
        Submit data
      </button>
      <button
        type="reset"
